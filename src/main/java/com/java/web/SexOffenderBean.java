...
public class SexOffenderBean {
	...
	public SexOffenderBean(Text value) {
		try {
	...
	public String toString() {
		return "CriminalBean [name=" + name + ", sido=" + sido + ", gungu=" + gungu + ", residence=" + residence
				+ ", realResidence=" + realResidence + "]";
	}
}
